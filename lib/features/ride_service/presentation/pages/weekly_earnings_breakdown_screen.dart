              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    const SizedBox(height: 16),
                    _buildEarningsRow('Ride Earnings', 'ETB 40,206.20'),
                    const SizedBox(height: 16),
                    _buildEarningsRow('Tips', 'ETB 40,206.20'),
                    const SizedBox(height: 16),
                    _buildEarningsRow('Bonuses', 'ETB 40,206.20'),
                    const SizedBox(height: 16),
                    _buildEarningsRow('Fuel Surcharge', 'ETB 40,206.20'),
                    const SizedBox(height: 16),
                    _buildEarningsRow('Tolls', 'ETB 40,206.20'),
                    const SizedBox(height: 16),
                    _buildEarningsRow('Deductions', 'ETB 40,206.20'),
                  ],
                ),
              ),
